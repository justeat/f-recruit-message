...
const recruitMessage = function () {
    ...
    "font-size:150px; margin-left:-55px; margin-top:-90px; padding-right:285px; background: url(http://dy3erx8o0a6nh.cloudfront.net/images/color-rays.png) 50% no-repeat;)");
};
