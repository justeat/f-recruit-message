...
const recruitMessage = () => {
    const fontStyle = 'font-family: Hind Vadodara, Arial, sans-serif; font-size: 14px; line-height: 1.5; color: #535353; background-color: #fff; margin-left: 55px';
    const fontStyleUnderline = `${fontStyle} text-decoration: underline; margin-left: 55px`;
    const logo = 'font-size:50px; margin-left:100px; padding-right:295px; background: url(https://dy3erx8o0a6nh.cloudfront.net/images/logo-just-eat-2016_x2.png) no-repeat;)';
